...
const ScrollPilot = () => {
    ...
    const handleScroll = () => {
        if (scrollContainerRef.current) { // save resources if this DOM doesn't exist
            ...
            if (closestBox) {
                container.scrollTo({
                    top: closestBox.offsetTop - (clientHeight / 2 - closestBox.offsetHeight / 2),
                    behavior: "smooth"
                });
            };
        };
    ...
    <div className={Styles.SomeDiv}>
        <div ref={scrollContainerRef} className={Styles.ScrollPilotModule}>
            ...
            <div className={Styles.SomeContent}/>
            <div className={Styles.SomeContent}><p>t1</p></div>
            <div className={Styles.SomeContent}><p>t2</p></div>
            <div className={Styles.SomeContent}><p>t3</p></div>
            <div className={Styles.SomeContent}><p>t4</p></div>
            <div className={Styles.SomeContent}><p>t5</p></div>
            <div className={Styles.SomeContent}><p>t6</p></div>
            <div className={Styles.SomeContent}><p>t7</p></div>
            <div className={Styles.SomeContent}/>
            <div className={Styles.SomeContent}/>
        </div>
