...
const MagScrollProvider = ({selectedCoefficient, setSelectedCoefficient, selectedVariable, setSelectedVariable, selectedExponent, setSelectedExponent}) => {
    ...
    */
    ...
    const renderFocusedComponent = () => {
        switch(focusPilot){
            case 1:
                return(
                    <MagScroll globalValue={globalValue1} setGlobalValue={handleSetGlobalValue1} memoryIndex={memoryIndex1} setMemoryIndex={setMemoryIndex1} library={library1}/>
                );
            case 2:
                return(
                    <MagScroll globalValue={globalValue2} setGlobalValue={handleSetGlobalValue2} memoryIndex={memoryIndex2} setMemoryIndex={setMemoryIndex2} library={library2}/>
                );
            case 3:
                return(
                    <MagScroll globalValue={globalValue3} setGlobalValue={handleSetGlobalValue3} memoryIndex={memoryIndex3} setMemoryIndex={setMemoryIndex3} library={library3}/>
                );
            default:
    ...
    return(hasLoaded ? <>
            ...
            <div>
                ...
                <button className={Styles.SelectLibraryButton} onClick={() => {handleSetFocusPilot(2)}}>{globalValue2}</button>
